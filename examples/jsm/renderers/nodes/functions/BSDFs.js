...
const F_Schlick = new FunctionNode( `
...
const G_BlinnPhong_Implicit = new FunctionNode( `
...
const D_BlinnPhong = new FunctionNode( `
...
const BRDF_Diffuse_Lambert = new FunctionNode( `
...
const BRDF_Specular_BlinnPhong = new FunctionNode( `
...
const punctualLightIntensityToIrradianceFactor = new FunctionNode( `
...
const RE_Direct_BlinnPhong = new FunctionNode( `
...
const RE_IndirectDiffuse_BlinnPhong = new FunctionNode( `
...
export { BRDF_Diffuse_Lambert, BRDF_Specular_BlinnPhong, D_BlinnPhong, F_Schlick, G_BlinnPhong_Implicit, RE_Direct_BlinnPhong, RE_IndirectDiffuse_BlinnPhong, punctualLightIntensityToIrradianceFactor };
