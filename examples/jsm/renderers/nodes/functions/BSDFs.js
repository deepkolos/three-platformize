...
const BRDF_Lambert = new FunctionNode( `
...
const getDistanceAttenuation = new FunctionNode( `
...
// https://seblagarde.files.wordpress.com/2015/07/course_notes_moving_frostbite_to_pbr_v32.pdf
const V_GGX_SmithCorrelated = new FunctionNode( `
...
const BRDF_Specular_GGX = new FunctionNode( `
...
const RE_Direct_Physical = new FunctionNode( `
...
const PhysicalLightingModel = new FunctionNode( `
...
export { BRDF_Lambert, BRDF_Specular_GGX, D_GGX, F_Schlick, G_BlinnPhong_Implicit, PhysicalLightingModel, RE_Direct_Physical, V_GGX_SmithCorrelated, getDistanceAttenuation, getSpecularMIPLevel };
