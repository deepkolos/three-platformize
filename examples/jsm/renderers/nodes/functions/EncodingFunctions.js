...
const cLogLuvM = new CodeNode( 'const mat3 cLogLuvMNode = mat3( 0.2209, 0.3390, 0.4184, 0.1138, 0.6780, 0.7319, 0.0102, 0.1130, 0.2969 );' );
...
const cLogLuvInverseM = new CodeNode( 'const mat3 cLogLuvInverseMNode = mat3( 6.0014, -2.7008, -1.7996, -1.3320, 3.1029, -5.7721, 0.3008, -1.0882, 5.6268 );' );
...
export { GammaToLinear, LinearToGamma, LinearToLinear, LinearToLogLuv, LinearToRGBD, LinearToRGBE, LinearToRGBM, LinearTosRGB, LogLuvToLinear, RGBDToLinear, RGBEToLinear, RGBMToLinear, cLogLuvInverseM, cLogLuvM, sRGBToLinear };
